...
static char *font = "Gohu GohuFont:Regular:pixelsize=14";
...
unsigned int defaultfg = DEFAULTFG;
unsigned int defaultbg = DEFAULTBG;
unsigned int defaultcs = DEFAULTCS;
static unsigned int defaultrcs = DEFAULTRCS;
...
#define CTRLALTMOD (ControlMask | MODKEY)
